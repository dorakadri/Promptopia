  ...
  const gotoprofile =(id)=> {
    ...
    <div className='prompt_card'>
      ...
      <div className='flex-1 flex justify-start items-center gap-3 cursor-pointer'>
        <Image src={post.creator.image} alt='user_image' width={40} height={40} className='rounded-full object-contain' onClick={()=>gotoprofile(post.creator._id)}/>
     <div className='flex flex-col'>
       ...
       <div className='copy_btn' onClick={handlecopy}>
        <Image src={copied===post.prompt ? '/assets/icons/tick.svg' :'/assets/icons/copy.svg'} width={12} height={12} alt='copupaste'/>
       </div>
